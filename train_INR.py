...
class Trainer():
    ...
    def data(self, batch1, pool):
        ...
        p = {'lr': lr, 'gt': batch1['gt'], 'cell': batch1['cell'], 'coord': batch1['coord'], 'scale': batch1['scale'].type(torch.cuda.FloatTensor)}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='config file path')
